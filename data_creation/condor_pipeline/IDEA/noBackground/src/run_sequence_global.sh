...
PFDIR=/afs/cern.ch/work/a/adevita/public/Tracking_DC_new
...
if [[ "${TYPE}" == "Pythia" ]]
      then 
      cp $PFDIR/data_creation/utils/Pythia_generation/${CONFIG}.cmd ${CONFIG}_${SEED}.cmd
      echo "Random:seed=${SEED}" >> ${CONFIG}_${SEED}.cmd

      k4run $PFDIR/data_creation/utils/Pythia_generation/pythia.py -n $NEV --Dumper.Filename out_hepmc/out_${SEED}.hepmc --Pythia8.PythiaInterface.pythiacard ${CONFIG}_${SEED}.cmd
