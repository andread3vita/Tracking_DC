...
def store_hit_col_VTX_SIW(
    ...
    Siw_D_hits = event.get("SiWrDCollection")
    Siw_B_hits = event.get("SiWrBCollection")
    
    hit_collections = [vtxD_hits, vtxB_hits,Siw_D_hits,Siw_B_hits]
        
    vtxD_hits_digi = event.get("VTXDDigis")
    vtxB_hits_digi = event.get("VTXBDigis")
    Siw_D_hits_digi = event.get("SiWrDDigis")
    Siw_B_hits_digi = event.get("SiWrBDigis")
        
    hit_collections_digi = [vtxD_hits_digi, vtxB_hits_digi,Siw_D_hits_digi,Siw_B_hits_digi]
    list_of_MCs1 = []
